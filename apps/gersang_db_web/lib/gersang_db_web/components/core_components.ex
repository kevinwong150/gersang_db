defmodule GersangDbWeb.CoreComponents do
  @moduledoc """
  ...
  def input(assigns) do
    ...
    <div phx-feedback-for={@name}>
      ...
      <input
        ...
        class={[
          "mt-2 p-2 border block w-full rounded-lg text-zinc-900 focus:ring-0 sm:text-sm sm:leading-6",
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(GersangDbWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(GersangDbWeb.Gettext, "errors", msg, opts)
    end
  end
